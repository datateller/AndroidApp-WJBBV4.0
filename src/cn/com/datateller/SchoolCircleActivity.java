...
public class SchoolCircleActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final Integer uid=UserHelper.readUserId(SchoolCircleActivity.this);
    	...
    	progressDialog=new ProgressDialog(SchoolCircleActivity.this);
				...
				case 1:
					...
					builder.setPositiveButton("确认", new OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							intent.setClass(SchoolCircleActivity.this,
									LoginActivity.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.school_circle, menu);
		return true;
	}
