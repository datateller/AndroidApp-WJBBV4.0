	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        finshButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Log.d(TAG, childname);
				if(childname==""){
					DialogHelper.showDialog(RegisterWithBabyInforActivity.this, "Baby 的姓名不能为空");
					return;
				}
...
//				TODO 无效的出生日期需要重新判断
				...
				if(etfamilyAddress.getText().toString()==""){
					DialogHelper.showDialog(RegisterWithBabyInforActivity.this, "为了能向您提供更好的个性化服务，请输入家庭地址信息，谢谢！");
				}
				...
				handler=new Handler(){
					...
					public void handleMessage(Message msg){
						...
						if(result.equals("True")){
							...
							DialogHelper.showDialog(RegisterWithBabyInforActivity.this, "用户名已存在，请重新注册");
						}
					}
				};
	...
	private Date getChildBirthday() {
		...
		if(year.equals("")|month.equals("")||day.equals("")){
			DialogHelper.showDialog(RegisterWithBabyInforActivity.this, "Baby出生日期不能为空");
			return null;
		}
